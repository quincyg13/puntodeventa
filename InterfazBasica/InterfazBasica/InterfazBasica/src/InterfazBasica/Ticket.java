...
String cadena="";
//tienen que crear la carpeta ticket en C:,
//pueden cambiar la dirreccion donde va a a guardar el pdf
String directorio = "C:\\ticket\\";
...
try{ 
    // si hay error checar la dirreccion del archivo
    FileOutputStream archivo = new FileOutputStream(directorio+"ticket.pdf");
    Document docpdf = new Document();
    PdfWriter.getInstance(docpdf, archivo);
    docpdf.open();
    //pueden probar con []bytes en lugar de cadena
    docpdf.add(new Paragraph(cadena));
    docpdf.close();
    pj.print(doc,null); 
}catch(Exception e){ } 
} 
